        ...
        <div class="card bg-success my-5" style="color: #fff;">
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    <div>
                        <img width="40px" height="40px" style="border-radius: 50%" class="m2-2" src="{{ Gravatar::src($discussion->bestReply->owner->email) }}" alt="">
                        <strong>
...
<strong class="card my-5">Replies</strong>
...
@foreach($discussion->replies()->paginate(2) as $reply)
    <div class="card my-5"> 
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <div>
                    <img width="40px" height="40px" sytle="border-radius: 50%" src="{{ Gravatar::src($reply->owner->email) }}" alt="">
